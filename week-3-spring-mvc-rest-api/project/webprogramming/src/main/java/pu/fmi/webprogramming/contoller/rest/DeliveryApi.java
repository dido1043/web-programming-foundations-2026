...
public class DeliveryApi {
  ...
  public ResponseEntity<Delivery> assignDelivery(@PathVariable Long id, @RequestParam Long courierId) {
      return ResponseEntity.ok(deliveryServiceInterface.assignCourier(id, courierId));
  }
